...
export function Footer() {
  return (
    <footer className="bg-charcoal text-cream pt-20 pb-10 border-t border-white/5">
      <div className="container mx-auto px-4 max-w-6xl">
            ...
            <div className="p-1 rounded-[2rem] bg-gradient-to-b from-white/10 to-white/5 border border-white/10">
              <div className="bg-[#2B2725] rounded-[calc(2rem-0.25rem)] p-6 space-y-4">
                <h4 className="font-serif text-lg font-semibold text-white flex items-center gap-2">
                  <Heart size={16} className="text-primary" /> Nhận ưu đãi hoa tươi
                </h4>
                ...
                >
                  <input
                    ...
                    className="bg-white/5 border border-white/10 rounded-full px-4 py-2.5 text-sm text-white placeholder:text-white/40 focus:outline-none focus:ring-1 focus:ring-primary w-full"
                  />
                  <Button className="rounded-full bg-primary hover:bg-primary-dark text-white px-5 py-2.5 text-sm shrink-0 font-medium transition-all">
                    Đăng ký
                  </Button>
                </form>
              </div>
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-white/50">
          ...
          <p className="flex items-center gap-1">
            Designed with <Heart size={12} className="text-primary fill-current" /> Korean Floral
            Aesthetic
          </p>
        </div>
      </div>
