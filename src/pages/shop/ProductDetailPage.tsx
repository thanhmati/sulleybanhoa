  ...
  if (!product) {
    return (
      <div className="container mx-auto px-4 py-24 text-center max-w-lg space-y-4">
        <h2 className="text-3xl font-serif text-foreground">Không tìm thấy sản phẩm</h2>
        <p className="text-gray-500 text-sm">
          Sản phẩm bạn đang tìm kiếm có thể đã tạm ngưng hoặc không tồn tại.
        </p>
        <Link to="/shop">
          <Button className="rounded-full bg-brand-dark text-white hover:bg-[#333] px-6">
            Quay lại cửa hàng
          </Button>
        </Link>
      </div>
  ...
  return (
    <div className="container mx-auto px-4 max-w-6xl py-10">
      ...
      <div className="mb-8">
        <Link
          to="/shop"
          className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white border border-border text-xs font-medium text-foreground hover:bg-primary/10 transition-colors shadow-sm"
        >
          <ArrowLeft size={14} className="text-primary-dark" />
      ...
      <div className="grid md:grid-cols-12 gap-12 items-start mb-24">
        ...
        <div className="md:col-span-6 space-y-4">
          <div className="p-2.5 rounded-[2.5rem] bg-white border border-border shadow-xl shadow-primary/10">
            <div className="relative aspect-[4/5] rounded-[calc(2.5rem-0.625rem)] overflow-hidden bg-cream">
        ...
        <div className="md:col-span-6 space-y-8 text-left">
          <div className="space-y-4">
            <div className="eyebrow-tag">THIẾT KẾ HOA THỦ CÔNG</div>
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-serif text-foreground leading-tight">
              {product.name}
            </h1>

            <div className="flex items-center gap-4 flex-wrap pt-1">
              <span className="text-2xl font-bold font-serif text-foreground bg-primary/20 px-4 py-1 rounded-full">
          ...
          <div className="flex flex-col sm:flex-row gap-4 pt-2">
            <a href="https://zalo.me" target="_blank" rel="noreferrer" className="flex-1">
              <Button className="w-full h-14 rounded-full bg-brand-dark hover:bg-[#333] text-white text-base font-medium transition-all hover:scale-[1.02] active:scale-[0.98] group flex items-center justify-center gap-3">
            ...
            <a href="tel:0349081629" className="flex-1">
              <Button
                variant="outline"
                className="w-full h-14 rounded-full border-2 border-foreground/20 bg-white hover:bg-foreground text-foreground hover:text-white text-base font-medium transition-all duration-300 group flex items-center justify-center gap-3"
              >
                <Phone size={18} />
                <span>034 908 1629</span>
                <span className="w-7 h-7 rounded-full bg-foreground/10 group-hover:bg-white/20 flex items-center justify-center text-foreground group-hover:text-white transition-colors">
                  <ArrowUpRight size={14} />
                </span>
              </Button>
            </a>
          ...
          <div className="p-1 rounded-[2rem] bg-white border border-border shadow-sm">
            <div className="p-5 rounded-[calc(2rem-0.25rem)] bg-cream grid grid-cols-2 gap-4">
              <div className="flex gap-3 items-center">
                <div className="w-10 h-10 rounded-full bg-primary/30 flex items-center justify-center text-primary-dark shrink-0">
                  <Truck size={18} />
                </div>
                <div>
                  <h4 className="font-semibold text-xs text-foreground">Giao hàng miễn phí</h4>
              ...
              <div className="flex gap-3 items-center">
                ...
                <div>
                  <h4 className="font-semibold text-xs text-foreground">Đảm bảo độ tươi</h4>
          ...
          <div className="space-y-3 pt-2">
            <h3 className="font-serif text-lg font-bold text-foreground">Hướng dẫn bảo quản</h3>
      ...
      {relatedProducts.length > 0 && (
        <div className="pt-16 border-t border-border">
          <div className="text-center max-w-xl mx-auto mb-12 space-y-2">
            <h2 className="text-3xl font-serif text-foreground">Có Thể Bạn Sẽ Thích</h2>
